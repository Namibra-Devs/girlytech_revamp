...
const options = [
  { label: 'Give a Scholarship', desc: "Fund a girl's journey into tech",    amount: 'From ₵500',   color: 'text-blue-400' },
  { label: 'Sponsor a Bootcamp', desc: 'Fund a full program cohort',         amount: 'From ₵5,000', color: 'text-sky-400' },
    ...
    <section className="py-20 lg:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-navy-950 to-navy-900 rounded-3xl relative overflow-hidden">
          ...
          <div className="absolute right-0 top-0 w-96 h-96 bg-blue-600/15 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl" />

          <div className="relative p-10 lg:p-16 grid lg:grid-cols-2 gap-12 items-center">
            {/* Left */}
            <div>
              <span className="inline-block px-3 py-1 bg-blue-500/15 text-blue-400 text-xs font-bold uppercase tracking-wider rounded-full mb-6">
                Take Action
              </span>
